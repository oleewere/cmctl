...
function run_release() {
  docker run -w /go/src/github.com/oleewere/cmctl -e GITHUB_TOKEN=$GITHUB_TOKEN --rm -v $CMCTL_ROOT_DIR/vendor/:/go/src/ -v $CMCTL_ROOT_DIR:/go/src/github.com/oleewere/cmctl bepsays/ci-goreleaser:latest goreleaser --debug --rm-dist
}

function build_only() {
  docker run -w /go/src/github.com/oleewere/cmctl -e GITHUB_TOKEN=$GITHUB_TOKEN --rm -v $CMCTL_ROOT_DIR/vendor/:/go/src/ -v $CMCTL_ROOT_DIR:/go/src/github.com/oleewere/cmctl bepsays/ci-goreleaser:latest goreleaser --snapshot --debug --rm-dist --skip-publish
}
